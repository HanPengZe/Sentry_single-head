...
//			Data_send(Vision.Sentry_Send_Msg_usb.Pack.yaw*ENCODER_ANGLE_RATIO,Vision.Sentry_Send_Msg_usb.Pack.pit*ENCODER_ANGLE_RATIO,Gimbal.YawPID[C_IMU+3][PID_Outer].Target,Gimbal.YawPID[C_IMU+3][PID_Outer].Current);
			
			Data_send(Gimbal.YawPID[C_IMU+3][PID_Outer].Target,Gimbal.YawPID[C_IMU+3][PID_Outer].Current,Gimbal.YawPID[C_IMU+3][PID_Inner].Target,Gimbal.YawPID[C_IMU+3][PID_Inner].Current);
//			Data_send(Gimbal.YawPID[C_IMU][PID_Outer].Target,Gimbal.YawPID[C_IMU][PID_Outer].Current,Gimbal.YawPID[C_IMU][PID_Inner].Target,Gimbal.YawPID[C_IMU][PID_Inner].Current);
