...
uint8_t Shoot_classdef::ShootFreq_Calc()
{
	...
	if(Infantry.shooter_barrel_heat_limit>=60000)
	{
		Shoot_Freq = 1000;
	}
	else
...
//	{		
		if((Sentry_Recv_Msg_usb.Pack.auto_aim==0 && Vision.aim_flag == 1)||ContLaunch == false)
				{
					Reload.Num = 0;
				}
//	}
...
//						CanShoot_Num[Turn_Bar_ID]--;
            ...
            Reload.Stuck_Duration = 0;
				...
				if(Judge_ReloadStall() == true)
				{
					...
					{
						Reload.Target_Angle = Reload_Motor.get_totalencoder()- GearTeeth_Angle;			
						Reload.Stuck_Duration = 0;
						mark=1;
					}					
				}
