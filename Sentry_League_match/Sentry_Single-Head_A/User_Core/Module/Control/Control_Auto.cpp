...
{
	if(Referee.GameRobotState.current_HP>450&&Referee.BulletRemaining.bullet_remaining_num_17mm>250)
	{
		 func = 1;//可以战斗
	}
	else if(Referee.GameRobotState.current_HP>450&&Referee.BulletRemaining.bullet_remaining_num_17mm<250)
	{
			func = 2;//血量健康留着弹丸守家
	}
	else if(Referee.GameRobotState.current_HP<450&&Referee.BulletRemaining.bullet_remaining_num_17mm>250)
...
//    {
//        if(Referee.GameState.stage_remain_time<60*5)//比赛剩余时间
//        {
//            //根据战术进行行动
//            OpenPointFlag=true;
//        } 
...
//        Last_GameRobotState_remain_HP-Referee.GameRobotState.current_HP>50)
//        {
//            HurtArmor_NoZero*=10;
        }
//    }
