...
//	uint16_t shooter_id1_17mm_cooling_rate;/* 17mm 枪口热量每秒冷却值*/
...
uint16_t current_HP; 															/*机器人当前血量*/
 uint16_t maximum_HP;															/*机器人血量上限*/
	uint16_t shooter_barrel_cooling_value;					//机器人枪口热量每秒冷却
	uint16_t shooter_barrel_heat_limit;							//热量上限
	uint16_t chassis_power_limit; 									//底盘最大功率上限
...
typedef struct {
	...
	uint16_t shooter_id1_17mm_heat; //第一个发射机构的枪口热量
